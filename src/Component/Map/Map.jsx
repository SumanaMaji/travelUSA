                ...
                <div className='maping'>
                    ...
                    <div>
                        ...
                        <div className='lastDiv'>
                            ...
                            <div className='map-Last-Image'>
                                {data.map((item, id) => (
                                    <div className='last_Image_Portion' key={id}>
                                        {/* {item.image != '' ? (
                                         <img src={`https://travel-api-lous.onrender.com/${item.image}`}></img>)
                                                 :
                                   ( <img src='https://file.kreditings.com/uploads/preview/sitting-lion-background-images-hd-for-picsart-11657445991avdajm08su.jpg'></img>
                                    )
                                            } */
